        ...
        <tr class="thead">
            ...
            <th><a href="<?php echo admin_url( 'admin.php?page=pmpro-approvals&s=' . esc_attr( $s ) . '&limit=' . $limit . '&pn=' . $pn . '&sortby=user_registered' ); ?>
                ...
                if ( $sortby == 'user_registered' && $sortorder == 'DESC' ) {
                    ?>
						&sortorder=ASC<?php } ?>"><?php _e( 'Username', 'pmpro-approvals' ); ?></a></th>
            <th><a href="<?php echo admin_url( 'admin.php?page=pmpro-approvals&s=' . esc_attr( $s ) . '&limit=' . $limit . '&pn=' . $pn . '&sortby=user_registered' ); ?>
										<?php
                if ( $sortby == 'user_registered' && $sortorder == 'DESC' ) {
                    ?>
						&sortorder=ASC<?php } ?>"><?php _e( 'Name', 'pmpro-approvals' ); ?></a></th>
            <th><a href="<?php echo admin_url( 'admin.php?page=pmpro-approvals&s=' . esc_attr( $s ) . '&limit=' . $limit . '&pn=' . $pn . '&sortby=user_registered' ); ?>
										<?php
                if ( $sortby == 'user_registered' && $sortorder == 'DESC' ) {
                    ?>
						&sortorder=ASC<?php } ?>"><?php _e( 'Email', 'pmpro-approvals' ); ?></a></th>
            <?php do_action( 'pmpro_approvals_list_extra_cols_header', $theusers ); ?>
            <th><a href="<?php echo admin_url( 'admin.php?page=pmpro-approvals&s=' . esc_attr( $s ) . '&limit=' . $limit . '&pn=' . $pn . '&sortby=user_registered' ); ?>
										<?php
                if ( $sortby == 'user_registered' && $sortorder == 'DESC' ) {
                    ?>
						&sortorder=ASC<?php } ?>"><?php _e( 'Membership', 'pmpro-approvals' ); ?></a></th>
            <th><a href="<?php echo admin_url( 'admin.php?page=pmpro-approvals&s=' . esc_attr( $s ) . '&limit=' . $limit . '&pn=' . $pn . '&sortby=user_registered' ); ?>
										<?php
                if ( $sortby == 'user_registered' && $sortorder == 'DESC' ) {
                    ?>
						&sortorder=ASC<?php } ?>"><?php _e( 'Title', 'pmpro-approvals' ); ?></a></th>
            <th><a href="<?php echo admin_url( 'admin.php?page=pmpro-approvals&s=' . esc_attr( $s ) . '&limit=' . $limit . '&pn=' . $pn . '&sortby=user_registered' ); ?>
										<?php
                if ( $sortby == 'user_registered' && $sortorder == 'DESC' ) {
                    ?>
						&sortorder=ASC<?php } ?>"><?php _e( 'Organization', 'pmpro-approvals' ); ?></a></th>
            <th><a href="<?php echo admin_url( 'admin.php?page=pmpro-approvals&s=' . esc_attr( $s ) . '&limit=' . $limit . '&pn=' . $pn . '&sortby=user_registered' ); ?>
										<?php
                if ( $sortby == 'user_registered' && $sortorder == 'DESC' ) {
                    ?>
						&sortorder=ASC<?php } ?>"><?php _e( 'School', 'pmpro-approvals' ); ?></a></th>
            <th><a href="<?php echo admin_url( 'admin.php?page=pmpro-approvals&s=' . esc_attr( $s ) . '&limit=' . $limit . '&pn=' . $pn . '&sortby=user_registered' ); ?>
										<?php
                if ( $sortby == 'user_registered' && $sortorder == 'DESC' ) {
                    ?>
						&sortorder=ASC<?php } ?>"><?php _e( 'Approval Status', 'pmpro-approvals' ); ?></a></th>
            <th><a href="<?php echo admin_url( 'admin123.php?page=pmpro-approvals&s=' . esc_attr( $s ) . '&limit=' . $limit . '&pn=' . $pn . '&sortby=user_registered' ); ?>
										<?php
                if ( $sortby == 'user_registered' && $sortorder == 'DESC' ) {
                    ?>
